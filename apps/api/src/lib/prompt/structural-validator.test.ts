...
function validPromptWithPreamble(): string {
  return [
    ...
    "",
    "## Objective",
    "Build a comprehensive feature for managing user subscriptions with automated billing and invoice generation. This forms the core monetization engine of the platform and must support multiple pricing tiers and payment methods.",
    "",
    "## Context",
    "This project needs a subscription management system built correctly. It handles tiered pricing plans, automatic monthly billing, invoice generation, and payment gateway integration with Stripe. The system must support upgrades, downgrades, cancellations, and prorated refunds. All billing operations must be auditable and comply with tax regulations across multiple jurisdictions where customers are located.",
    "",
    "## Constraints",
    "- One constraint",
    "",
    "## Expected Output",
    "A complete implementation of the subscription management feature with billing integration, invoice PDF generation, and admin dashboard for managing customer subscriptions and payment history. The system must handle recurring billing, failed payment retries, and subscription lifecycle events reliably.",
    "",
    "## Validation Criteria",
    "- Criteria one",
    "",
