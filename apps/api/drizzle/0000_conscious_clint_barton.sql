...
CREATE TABLE "task_dependencies" (
	...
	"dependency_type" varchar(15) DEFAULT 'blocks' NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL
);
--> statement-breakpoint
...
ALTER TABLE "execution_tasks" ADD CONSTRAINT "execution_tasks_plan_id_plans_id_fk" FOREIGN KEY ("plan_id") REFERENCES "public"."plans"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "execution_tasks" ADD CONSTRAINT "execution_tasks_phase_id_phases_id_fk" FOREIGN KEY ("phase_id") REFERENCES "public"."phases"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "execution_tasks" ADD CONSTRAINT "execution_tasks_subphase_id_subphases_id_fk" FOREIGN KEY ("subphase_id") REFERENCES "public"."subphases"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "generation_versions" ADD CONSTRAINT "generation_versions_task_id_execution_tasks_id_fk" FOREIGN KEY ("task_id") REFERENCES "public"."execution_tasks"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "generation_versions" ADD CONSTRAINT "generation_versions_plan_id_plans_id_fk" FOREIGN KEY ("plan_id") REFERENCES "public"."plans"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "prompt_artifacts" ADD CONSTRAINT "prompt_artifacts_task_id_execution_tasks_id_fk" FOREIGN KEY ("task_id") REFERENCES "public"."execution_tasks"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "task_dependencies" ADD CONSTRAINT "task_dependencies_task_id_execution_tasks_id_fk" FOREIGN KEY ("task_id") REFERENCES "public"."execution_tasks"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "task_dependencies" ADD CONSTRAINT "task_dependencies_depends_on_task_id_execution_tasks_id_fk" FOREIGN KEY ("depends_on_task_id") REFERENCES "public"."execution_tasks"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "exec_tasks_plan_id_idx" ON "execution_tasks" USING btree ("plan_id");--> statement-breakpoint
CREATE INDEX "exec_tasks_phase_id_idx" ON "execution_tasks" USING btree ("phase_id");--> statement-breakpoint
CREATE INDEX "exec_tasks_status_idx" ON "execution_tasks" USING btree ("status");--> statement-breakpoint
CREATE INDEX "gen_versions_task_id_idx" ON "generation_versions" USING btree ("task_id");--> statement-breakpoint
CREATE INDEX "gen_versions_plan_id_idx" ON "generation_versions" USING btree ("plan_id");--> statement-breakpoint
...
CREATE INDEX "prompt_artifacts_task_id_idx" ON "prompt_artifacts" USING btree ("task_id");--> statement-breakpoint
